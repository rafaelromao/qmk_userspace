...
**This is a historical QMK  repository, not updated anymore. The current version is only available for ZMK and can be found in my [keyboards](https://github.com/rafaelromao/keyboards) repo.**
...
For the ZMK version, check my [keyboards](https://github.com/rafaelromao/keyboards) repo.
